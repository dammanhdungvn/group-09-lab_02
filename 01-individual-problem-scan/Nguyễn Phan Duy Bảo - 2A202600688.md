...
Dưới đây là danh sách 10 vấn đề được quan sát và ghi nhận dựa trên trải nghiệm thực tế trong học tập và nghiên cứu khoa học:
...
| 4 | Lặp lại | Cần format báo cáo LaTeX/Word đúng chuẩn theo mẫu của trường (lỗi bảng, hình, heading, mục lục) | Sinh viên | Mất 2-3 tiếng căn chỉnh format thủ công trước khi nộp bài. |
...
| 7 | AI có thể tốt hơn | Không biết chèn hình/chứng cứ và kết quả demo vào phần nào trong báo cáo (bằng chứng nằm rải rác) | Sinh viên làm demo | Dễ chèn sai chỗ hoặc quên chèn minh chứng ảnh khiến bài bị trừ điểm. |
...
| 10 | AI có thể tốt hơn | Cuối sát deadline mới phát hiện thiếu chương kiểm thử hoặc thiếu các rubric bắt buộc của bài báo cáo | Sinh viên | Báo cáo bị thiếu điểm phần kiểm thử do checklist nộp bài không rõ ràng. |
...
## Sơ đồ Workflow trước và sau cải tiến
...
## Kế hoạch Pitch và Challenge bài toán Rank 1
